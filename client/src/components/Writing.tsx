...
const writings = [
  ...
  {
    type: "Article",
    title: "It's Almost International Women's Day and I Think We Are Starting to Figure It Out",
    venue: "LinkedIn",
    date: "March 2018",
    description: "A personal reflection on being the only woman in the room throughout a tech career, and what it means for the industry to finally start making progress.",
    url: "https://www.linkedin.com/pulse/its-almost-international-womens-day-i-think-we-starting-williams/",
    color: "#00f5ff",
  },
  {
    type: "Podcast",
